    ...
    <Container pt="5rem">
      ...
      <Box display={{md: 'flex'}}>
				...
				<Box flexShrink={0} mt={{base: 4, md:0}} ml={{md:6}}>
					<Image borderColor="whiteAlpha.800" borderWidth={4} bodrerStyle="solid" maxWidth="100px" display="inline-block" borderRadius="full" src="images/cool.jpg" alt="Complimenting image of Tadeas Tran"/>
				</Box>
			</Box>
			</Section>
